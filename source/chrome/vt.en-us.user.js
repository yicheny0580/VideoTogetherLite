...
(function () {
  ...
  <div class="vt-modal-footer">
    <div id="lobbyBtnGroup">
      <button id="videoTogetherCreateButton" class="vt-btn vt-btn-primary" type="button">Create</button>
      <button id="videoTogetherJoinButton" class="vt-btn vt-btn-secondary" type="button">Join</button>
    </div>
    <div id="roomButtonGroup" style="display: none;">
      <button id="videoTogetherExitButton" class="vt-btn vt-btn-dangerous" type="button">Exit</button>
    </div>
    <button id="videoTogetherHelpButton" class="vt-btn" type="button">Help</button>
  </div>
</div>
...
`);
        ...
        setRole(role) {
            switch (role) {
                case RoleEnum.Master:
                    updateInnerHTML(this.roleText, "Host");
                    break;
                case RoleEnum.Member:
                    updateInnerHTML(this.roleText, "Member");
                    break;
                default:
    ...
    class VideoTogetherExtension {
        ...
        createRoom(name, password) {
            if (name == "") {
                this.updateStatus("Please input room name", "red");
                return;
            }
            this.tempUser = generateTempUserId();
            this.roomName = name;
        ...
        async masterTask() {
            ...
            this.saveState("");
            this.updateStatus("Sync " + this.getDisplayTimeText(), "green");
        }
